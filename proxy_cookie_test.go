	...
	tests := []struct {
	...
	}{
		{
			...
			reqHeader: map[string][]string{
				"set-cookie":    {"session_id=someValue; Path=/"},
				"anotherHeader": {"Path=/"},
			},
			expRespHeader: map[string][]string{
				"set-cookie":    {"session_id=someValue; Path=/foo"},
				"anotherHeader": {"Path=/"},
			},
		},
		{
		...
		},
		{
			...
			pathPrefix: "foo",
			reqHeader: map[string][]string{
				"set-cookie":    {"session_id=someValue"},
				"anotherHeader": {"Path=/"},
			},
			expRespHeader: map[string][]string{
				"set-cookie":    {"session_id=someValue; Path=/foo"},
		...
		},
		{
			...
			expRespHeader: map[string][]string{
				"set-cookie":    {"session_id=someValue; Path=/bar"},
				"anotherHeader": {"Path=/"},
			},
		},
		{
			...
			reqHeader: map[string][]string{
				"set-cookie":    {"session_id=someValue; Domain=www.foo.com"},
				"anotherHeader": {"Path=/"},
			},
			expRespHeader: map[string][]string{
				"set-cookie":    {"session_id=someValue; Domain=www.foo.com"},
		...
		},
		{
			...
			reqHeader: map[string][]string{
				"set-cookie":    {"session_id=someValue; Path=/bar/foo/something"},
				"anotherHeader": {"Path=/"},
			},
			expRespHeader: map[string][]string{
				"set-cookie":    {"session_id=someValue; Path=/foo/something"},
				"anotherHeader": {"Path=/"},
			},
		},
		{
		...
		},
		{
			...
			expRespHeader: map[string][]string{
				"set-cookie":    {"session_id=someValue; Domain=www.bar.com"},
				"anotherHeader": {"Path=/"},
			},
		},
		{
		...
		},
		{
			...
			reqHeader: map[string][]string{
				"set-cookie":    {"session_id=someValue; Domain=subdomain.foo.bar"},
				"anotherHeader": {"Path=/"},
			},
			expRespHeader: map[string][]string{
				"set-cookie":    {"session_id=someValue; Domain=foo.bar"},
				"anotherHeader": {"Path=/"},
			},
		},
	}
